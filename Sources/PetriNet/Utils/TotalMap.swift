...
public struct TotalMap<Key, Value> where Key: CaseIterable & Hashable {
  ...
  ///
  /// - Parameter mapping: A dictionary containing the keys and values of this total map.
  ///
  /// - Warning:
  ...
  ///
  /// - Parameter mapping: The function mapping the keys of this total map to their respective values.
  ...
  ///
  /// - Parameter key: The key to find in the total map.
  ///
